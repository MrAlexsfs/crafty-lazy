...
int NextRootMove(TREE *RESTRICT, TREE *RESTRICT, int, int);
int NextRootMoveParallel(int);
...
int Search(TREE *RESTRICT, int, int, int, int, int, int, int, int);
int SearchMove(TREE *RESTRICT, int, int, int, int, int, int, int, int, int, int);
int SearchMoveList(TREE *RESTRICT, int, int, int, int, int, int *, int, int, int, int);
